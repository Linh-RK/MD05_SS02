...
import Task09_product from "./task09_product";

export default function Task09() {
  const products = [
    {
      id: 1,
      proName: "Apple new mac book 2015 March",
      image: "./public/img/product-1.jpg",
      price1: 899.0,
      price2: 999.0,
    },
    {
      id: 2,
      proName: "Apple new mac book 2015 March",
      image: "./public/img/product-2.jpg",
      price1: 899.0,
      price2: 999.0,
    },
    {
      id: 3,
      proName: "Apple new mac book 2015 March",
      image: "./public/img/product-3.jpg",
      price1: 899.0,
      price2: 999.0,
    },
    {
      id: 4,
      proName: "Apple new mac book 2015 March",
      image: "./public/img/product-4.jpg",
      price1: 899.0,
      price2: 999.0,
    },
  ];
          ...
          <div className="row">
            {products.map((pro, index) => (
              <React.Fragment key={pro.id}>
                <Task09_product pro={pro} index={index} />
              </React.Fragment>
            ))}
          </div>
        </div>
